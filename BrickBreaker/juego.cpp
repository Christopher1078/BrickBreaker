...
void Juego::crearPelotaExtra()
{
    ...
    escena->addItem(
        nuevaPelota->getGrafico()
        );

    NodoPelota* nuevoNodo =
        new NodoPelota;
...
void Juego::revisarColisionBloques(
    Pelota* p
    )
{
    for(int i = 0; i < FILAS; i++)
